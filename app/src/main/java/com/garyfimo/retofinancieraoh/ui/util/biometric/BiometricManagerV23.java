package com.garyfimo.retofinancieraoh.ui.util.biometric;
...
public class BiometricManagerV23 {
    ...
    private static final String TAG = BiometricManagerV23.class.getSimpleName();
    ...
    void displayBiometricPromptV23(final BiometricCallback biometricCallback) {
        ...
        if (initCipher()) {
            ...
            displayBiometricV23Dialog(biometricCallback);
        }
    }


    private void displayBiometricV23Dialog(final BiometricCallback biometricCallback) {
